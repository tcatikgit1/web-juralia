...
@section('title', 'Juralia - política')
@section('meta-seo')
...
<section id="politicas">
    <div class="col-4 offset-4 po-logo"></div>
    ...
    <div class="contenido row col-12 mx-0 px-0 justify-content-center">
        <div class="container">
            ...
            <ul>
                <li>RED FOX ENGINEERING SL</li>
                <li>CIF: B76349158</li>
                <li>Calle San Nicolás 9</li>
                <li>Las Palmas de Gran Canaria (35002)</li>
                <li>Tlfno: 828701918</li>
                <li>Mail: gestion@tcatik.com</li>
            </ul>
